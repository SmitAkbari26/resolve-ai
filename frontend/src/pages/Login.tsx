...
interface LoginProps {
  onLoginSuccess: (token: string, role: 'admin' | 'customer', user_id: string, email:string) => void;
}
...
export const Login: React.FC<LoginProps> = ({ onLoginSuccess }) => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      onLoginSuccess(data.access_token, data.role, data.user_id, data.email);
      ...
      setError(
        err.response?.data?.detail ||
          'Invalid credentials or backend connection error.'
      );
    } finally {
      setLoading(false);
    }
    ...
    <div className="min-h-screen bg-[#050814] flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="glass-card rounded-3xl overflow-hidden border border-slate-800/70 shadow-2xl backdrop-blur-xl">
          ...
          {/* Header */}
          <div className="px-8 pt-10 pb-8 text-center border-b border-slate-800/40 relative">
            ...
            <p className="text-slate-400 text-sm mt-2">
              Agentic Customer Support Resolution Platform
            </p>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="admin@resolveai.com"
